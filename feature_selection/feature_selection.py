...
(1) model_predict_and_evaluate: train model with subset of the features and evalaute the performance
...
class FeatureSelection:
  ...
  def __init__ (self, feature_selection_model_name, feature_type, feature_number, 
                task, metric_name, metric_parameters, model_parameters = None):
    ...
    if self.model_parameters == None:
      self.model_parameters = {'model_type': 'gru',
                               'h_dim': 10,
                               'n_head': 2,
                               'n_layer': 2,
                               'batch_size': 100,
  ...
  def fit (self, dataset):
    ...
    """    
    assert self.feature_selection_model_name in ['greedy-addition', 'greedy-deletion',
                                                 'recursive-addition', 'recursive-deletion', None]    
