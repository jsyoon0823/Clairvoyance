...
def rnn_fit(hyperparams_encoder_iptw, dataset_train, dataset_val, networks_to_train, task, MODEL_ROOT):
  ...
  specifications = {
    'rnn_propensity_weighted': (hyperparams_encoder_iptw['dropout_rate'], hyperparams_encoder_iptw['memory_multiplier'],
                                hyperparams_encoder_iptw['num_epochs'], hyperparams_encoder_iptw['batch_size'],
                                hyperparams_encoder_iptw['learning_rate'], hyperparams_encoder_iptw['max_norm']),
